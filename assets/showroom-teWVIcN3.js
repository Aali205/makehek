...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function es(e,t,n){return new fa({name:`SphericalGaussianBlur`,defines:{SAMPLES:zo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:rs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ts(){return new fa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:rs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ns(){return new fa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:rs(),fragmentShader:`
	...
	`}var is=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new vi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      void main() {
        ...
        float star = max(smoothstep(0.08, 0.0, abs(p.x)) * smoothstep(0.5, 0.0, abs(p.y)),
                         smoothstep(0.08, 0.0, abs(p.y)) * smoothstep(0.5, 0.0, abs(p.x)));
        float a = (pow(core, 3.0) + star * 0.8) * vAlpha;
        if (a < 0.01) discard;
        gl_FragColor = vec4(uColor, a);
      }`,transparent:!0,depthWrite:!1,blending:2}))}function Du(e=1){let t=document.createElement(`canvas`);t.width=t.height=256;let r=t.getContext(`2d`),i=r.createImageData(256,256);for(let e=0;e<i.data.length;e+=4){let t=120+Math.random()*135;i.data[e]=i.data[e+1]=i.data[e+2]=t,i.data[e+3]=255}r.putImageData(i,0,0);let a=new yi(t);return a.wrapS=a.wrapT=n,a.repeat.set(10*e,14*e),a}function Ou(e,t,n,r=!1){let i=new X(new na(new Fi(e.map(e=>new G(...e)),r,`centripetal`),120,t,16,r),n);return i.castShadow=!0,i}function ku(){let e=new wn,t=new ha({color:`#f4eee8`,roughness:.85,sheen:.6,sheenColor:new J(`#ffffff`)}),n=new X(Tu(gu([[1.63,0,0],[1.625,.055,.05],[1.58,.052,.047],[1.52,.06,.055],[1.47,.17,.1],[1.43,.2,.115],[1.36,.185,.125],[1.28,.17,.125],[1.1,.13,.095]]),80,96),t);n.castShadow=!0,e.add(n);let r=new ma({color:`#c8a26b`,metalness:1,roughness:.25}),i=new X(new ea(.05,32,16,0,Math.PI*2,0,Math.PI/2),r);i.scale.set(1.1,.5,1),i.position.y=1.625,e.add(i);let a=new X(new ea(.018,24,16),r);a.position.y=1.66,e.add(a);let o=new X(new Ti(.014,.018,1.12,24),r);return o.position.y=.56,o.castShadow=!0,e.add(o),e}function Au(){let e=new wn,t=gu([[1.38,.19,.134],[1.3,.182,.136],[1.18,.143,.104],[1.06,.128,.094],[.92,.172,.124],[.7,.158,.118],[.46,.128,.102],[.27,.2,.17],[.01,.42,.38]],(e,t)=>.012*Math.sin(9*t+e*22)*hu(.05,.3,e)*(1-hu(.55,.7,e))+.07*Math.sin(13*t)*hu(.68,1,e)),n=new ha({color:`#c9c8d4`,metalness:.75,roughness:.32,roughnessMap:Du(1.5),clearcoat:.4,iridescence:.35,side:2}),r=new X(Tu(t),n);r.castShadow=!0,e.add(r);let i=[];for(let e=0;e<=64;e++){let t=e/64*Math.PI*2,n=Math.max(0,Math.sin(t));i.push([Math.cos(t)*.225,1.4-.035*n+.02*Math.cos(2*t),Math.sin(t)*.15])}let a=Ou(i,.032,n,!0);return a.scale.set(1,1,1.02),e.add(a),e.add(Eu(t,{count:3200,color:`#ffffff`,size:14})),e.add(Eu(t,{count:600,color:`#ffd9ec`,size:18})),e}function ju(){let e=new wn,t=gu([[1.36,.176,.13],[1.3,.178,.132],[1.14,.132,.098],[1.04,.126,.094],[.99,.24,.22],[.8,.42,.4],[.45,.56,.53],[.01,.66,.62]],(e,t)=>(.045*Math.sin(16*t+.8*Math.sin(3*t))+.02*Math.sin(7*t+1.3))*hu(.33,.9,e)),n=new ha({color:`#6e0016`,roughness:.55,roughnessMap:Du(2),sheen:.7,sheenColor:new J(`#ff2a4f`),sheenRoughness:.4,clearcoat:.2,side:2}),r=new X(Tu(t),n);r.castShadow=!0,e.add(r);let i=new X(new ta(1,.016,12,96),new ha({color:`#ffe6c7`,metalness:1,roughness:.15}));return i.rotation.x=Math.PI/2,i.scale.set(.132,.098,1),i.position.y=1.045,e.add(i),e.add(Eu(t,{count:2600,tMin:.3,color:`#ffd7a8`,size:13,density:e=>.35+e*.65})),e.add(Eu(t,{count:700,tMax:.3,color:`#ffffff`,size:12})),e}function Mu(){let e=new wn,t=gu([[1.38,.18,.13],[1.3,.18,.134],[1.16,.138,.1],[1.05,.128,.094],[.9,.2,.16],[.5,.33,.29],[.01,.48,.44]],(e,t)=>.03*Math.sin(10*t+.4)*hu(.35,1,e)),n=new ha({color:`#d6006f`,roughness:.28,sheen:1,sheenColor:new J(`#ff9ccd`),sheenRoughness:.25,clearcoat:.6,clearcoatRoughness:.2,side:2}),r=new X(Tu(t),n);r.castShadow=!0,e.add(r),e.add(Ou([[.14,1.36,.1],[.17,1.44,.06],[.175,1.47,0],[.16,1.43,-.07],[.12,1.34,-.12]],.028,n));let i=n.clone();i.color=new J(`#ff4fa7`);let a=new G;for(let r=0;r<4;r++){let o=[];for(let e=0;e<=40;e++){let n=e/40;t(.05+n*(.55+r*.08),-.6+r*.5+n*(2.2+r*.3),a,.035),o.push([a.x,a.y,a.z])}e.add(Ou(o,.018-r*.002,r%2?i:n))}return e.add(Eu(t,{count:900,color:`#ffe3f1`,size:11})),e}var Nu;function Pu(e,t){if(!Nu){Nu=document.createElement(`canvas`),Nu.width=Nu.height=256;let e=Nu.getContext(`2d`);e.fillStyle=`#5a0413`,e.fillRect(0,0,256,256);let t=(t,n,r)=>{e.save(),e.translate(t,n),e.scale(r,r),e.fillStyle=`#8a1428`;for(let t=0;t<4;t++)e.rotate(Math.PI/2),e.beginPath(),e.ellipse(0,-22,9,19,0,0,Math.PI*2),e.fill();e.strokeStyle=`#8a1428`,e.lineWidth=3;for(let t=0;t<4;t++)e.rotate(Math.PI/2),e.beginPath(),e.moveTo(0,-46),e.quadraticCurveTo(26,-42,30,-24),e.stroke();e.fillStyle=`#3c020c`,e.beginPath(),e.arc(0,0,8,0,Math.PI*2),e.fill(),e.restore()};t(64,64,1),t(192,192,1),t(192,64,.55),t(64,192,.55)}let r=new yi(Nu);return r.colorSpace=Le,r.wrapS=r.wrapT=n,r.repeat.set(e,t),r.anisotropy=8,r}function Fu(){let e=new wn,t=(e,t)=>new ha({color:`#b8606c`,map:Pu(e,t),roughness:.5,sheen:.35,sheenColor:new J(`#c01a36`),sheenRoughness:.35,side:2}),n=new ha({color:`#8c0a20`,roughness:.4,sheen:.5,sheenColor:new J(`#ff5470`)}),r=e=>{let t=bu(e);return 1.395+.015*xu(Math.abs(t),.42,.2)-.05*xu(t,0,.13)-Su(e)},i=(e,t,n,i=0)=>yu(t,r(t)-e*(r(t)-1.05),n,i+.01);e.add(new X(Tu(i,60,200),t(6,3))),e.add(new X(Tu((e,t,n,i=0)=>{let a=.08+.45*Math.sin(Math.PI*Math.min(1,e*1.05))**.8,o=Math.PI/2+a+t/(Math.PI*2)*(Math.PI*2-2*a),s=xu(Math.abs(Math.cos(o)),1,.3);return yu(o,1.52-e*(1.52-(r(o)+(1.455-r(o))*s)),n,i+.012)},30,160),t(5,1)));let a=new X(new Ti(.064,.071,.085,64,1,!0),t(3,.4));a.position.y=1.558,e.add(a);let o=new X(new ta(.064,.006,8,64),n);o.rotation.x=Math.PI/2,o.position.y=1.6,e.add(o);let s=new G,c=(e,t,n=0,r=Math.PI*2,i=90)=>Array.from({length:i+1},(a,o)=>e(t,n+(r-n)*o/i,s,.02).toArray());e.add(Ou(c(i,0),.006,n,!0)),e.add(Ou(c(i,1),.007,n,!0));let l=e=>.34+.28*Math.sin(e),u=(e,t,n,r=0)=>{let i=1.05-e*(1.05-l(t)),a=(1.05-i)**.9,o=1+(.05+.04*(1-Math.abs(Math.sin(t))))*Math.sin(11*t+.6*Math.sin(3*t))*hu(.12,1,e)+r;return n.set(Math.cos(t)*(.13+.44*a)*o,i,Math.sin(t)*(.096+.44*a)*o)},d=new X(Tu(u,90,220),t(10,5));d.castShadow=!0,e.add(d);let f=[];for(let e=0;e<=8;e++){let t=1.33-e*.028;yu(-Math.PI/2+(e%2?.11:-.11),t,s,.03),f.push(s.toArray())}let p=new ha({color:`#4a0010`,roughness:.3,sheen:1,sheenColor:new J(`#ff4060`)});return e.add(Ou(f,.004,p)),[-1,1].forEach(t=>e.add(Ou([f[8],[t*.03,1.08,-.115],[t*.05,.92,-.2],[t*.04,.78,-.27]],.005,p))),e.add(Eu(u,{count:500,color:`#ffc2cc`,size:8})),e}function Iu(){let e=new wn,t=new ha({color:`#d2549b`,roughness:.62,sheen:.45,sheenColor:new J(`#f59ccb`),sheenRoughness:.5,side:2}),n=e=>{let t=bu(e);return 1.39+.012*xu(Math.abs(t),.45,.2)-.035*xu(t,0,.14)-.09*xu(Math.abs(t),Math.PI,.75)-Su(e)},r=new X(Tu((e,t,r,i=0)=>yu(t,n(t)-e*(n(t)-1.05),r,i+.01),60,200),t);r.castShadow=!0,e.add(r);let i=.22000000000000003/2,a=n(Math.acos(i/vu(1.39)[0]))-.015,o=n(-Math.acos(i/vu(1.31)[0]))-.015;e.add(wu(Cu(.085,.135,a,o),t));let s=gu([[1.05,.13,.096],[.95,.2,.185],[.7,.34,.32],[.4,.44,.42]],(e,t)=>.08*Math.sin(14*t+.5*Math.sin(2*t))*hu(.05,1,e)**1.2),c=new X(Tu(s,80,240),t);c.castShadow=!0,e.add(c);let l=new ma({color:`#c0649c`,roughness:.4}),u=new G;return e.add(Ou([yu(-Math.PI/2,1.3,u,.02).toArray(),yu(-Math.PI/2,1.1,u,.02).toArray(),s(.28,-Math.PI/2,u,.01).toArray()],.003,l)),e}function Lu({el:e,getLang:t,onShop:n,start:r}){let i=e.querySelector(`.showroom__stage`),a=new Hl({antialias:!0,alpha:!0});a.setPixelRatio(Math.min(devicePixelRatio,2)),a.toneMapping=4,a.toneMappingExposure=1.05,a.shadowMap.enabled=!0,a.shadowMap.type=1,i.append(a.domElement);let o=new Mn;o.environment=new Yo(a).fromScene(new du,.04).texture;let s=new Za(28,1,.1,50);s.position.set(0,1.05,4.6);let c=new Ql(s,a.domElement);c.target.set(0,.8,0),c.enableDamping=!0,c.enablePan=!1,c.minDistance=2.4,c.maxDistance=6,c.minPolarAngle=.9,c.maxPolarAngle=1.72,c.autoRotate=!0,c.autoRotateSpeed=1.6,c.enableZoom=!1,c.update();let l;c.addEventListener(`start`,()=>{c.autoRotate=!1,e.classList.add(`is-dragging`,`was-dragged`),clearTimeout(l)}),c.addEventListener(`end`,()=>{e.classList.remove(`is-dragging`),l=setTimeout(()=>{c.autoRotate=y},2500)}),o.add(new za(`#fff4f8`,`#f6bdd6`,.6));let u=new $a(`#ffffff`,60,12,.5,.6,1.4);u.position.set(2.2,4,3),u.target.position.set(0,.8,0),u.castShadow=!0,u.shadow.mapSize.set(1024,1024),u.shadow.bias=-5e-4,o.add(u,u.target);let d=new to(`#ff4fa7`,12,8);d.position.set(-2.4,1.8,-2),o.add(d);let f=new to(`#ffe9d6`,6,8);f.position.set(2.5,1,-1.5),o.add(f);let p=new X(new Ti(.85,.9,.08,96),new ha({color:`#fff7fa`,roughness:.2,clearcoat:1}));p.position.y=-.04,p.receiveShadow=!0,o.add(p);let m=new X(new ta(.875,.012,16,128),new ma({color:`#c8a26b`,metalness:1,roughness:.2}));m.rotation.x=Math.PI/2,m.position.y=0,o.add(m);let h=new X(new wi(4,64),new ra({opacity:.12}));h.rotation.x=-Math.PI/2,h.position.y=-.081,h.receiveShadow=!0,o.add(h);let g=new wn;g.add(ku()),o.add(g);let _=pu.map(e=>{let t=e.build();return t.visible=!1,g.add(t),t}),v=Math.max(0,pu.findIndex(e=>e.id===r)),y=!0,b=1,x=e.querySelector(`.showroom__tabs`),S=e.querySelector(`.showroom__name`),C=e.querySelector(`.showroom__desc`),w=e.querySelector(`.showroom__shop`),T=e.querySelector(`.showroom__hint span`),E=e.querySelector(`.showroom__auto`);function D(){let e=t();x.innerHTML=pu.map((t,n)=>`<button class="showroom__tab ${n===v?`is-active`:``}" data-dress="${n}"><i style="background:${t.swatch}"></i>${t.name[e]}</button>`).join(``),S.textContent=pu[v].name[e],C.textContent=pu[v].desc[e],w.textContent=mu[e].shop,T.textContent=mu[e].hint,E.setAttribute(`aria-label`,mu[e].auto)}function O(e){_[v].visible=!1,v=e,_[v].visible=!0,b=0,D()}x.addEventListener(`click`,e=>{let t=e.target.closest(`[data-dress]`);t&&+t.dataset.dress!==v&&O(+t.dataset.dress)}),w.addEventListener(`click`,()=>n(pu[v].id)),E.addEventListener(`click`,()=>{y=!y,c.autoRotate=y,E.classList.toggle(`is-off`,!y)}),document.addEventListener(`langchange`,D),_[v].visible=!0,D();let k=()=>{let{clientWidth:e,clientHeight:t}=i;a.setSize(e,t,!1),s.aspect=e/t,s.position.setLength(e<560?5.4:4.6),s.updateProjectionMatrix();let n=a.getPixelRatio();_.forEach(e=>e.traverse(e=>{e.isPoints&&(e.material.uniforms.uPixelRatio.value=t/720*n)}))};new ResizeObserver(k).observe(i),k();let A=!0;new IntersectionObserver(([e])=>{A=e.isIntersecting,A&&te()}).observe(e);let j=new so,ee=0;function te(){if(cancelAnimationFrame(ee),!A)return;ee=requestAnimationFrame(te),j.update();let e=j.getElapsed();if(b<1){b=Math.min(1,b+.025);let e=1-(1-b)**3;_[v].rotation.y=(1-e)*Math.PI*1.5,_[v].scale.setScalar(.92+.08*e)}_[v].traverse(t=>{t.isPoints&&(t.material.uniforms.uTime.value=e)}),c.update(),a.render(o,s)}te(),e.classList.add(`is-ready`)}export{Lu as initShowroom};